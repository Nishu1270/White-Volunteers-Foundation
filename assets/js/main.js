...
function initMobileNav() {
  ...
  const drawerLinks = drawer.querySelectorAll('a:not(.has-sub)');
...
/* ==========================================================================
   9. Video Stream Carousel (Smooth Navigation & Lightbox Triggers)
   ========================================================================== */
function initVideoStreamCarousel() {
  ...
  containers.forEach(container => {
    ...
    const cards = container.querySelectorAll('.video-stream-card');
    const prevBtn = container.closest('.video-stream-section-wrap')?.querySelector('.video-prev-btn');
    const nextBtn = container.closest('.video-stream-section-wrap')?.querySelector('.video-next-btn');
    const dotsContainer = container.closest('.video-stream-section-wrap')?.querySelector('.video-carousel-dots');
    ...
    if (dotsContainer) {
      ...
      for (let i = 0; i < totalCards; i++) {
        ...
        dot.setAttribute('title', `Video ${i + 1}`);
